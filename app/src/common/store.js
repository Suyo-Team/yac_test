export const chats = [
    {
        id: 1,
        admin: 1,
        nameRoom: 'Soccer lover ♥',
        state: 'the life is football',
        url: 'https://i.gr-assets.com/images/S/compressed.photo.goodreads.com/books/1563345154l/50868413._SX0_SY0_.jpg',
        members: [],
        messages: []
    },
    {
    ...
    },
    {
        id: 43,
        admin: 1,
        nameRoom: 'Diegonorrea',
        state: 'the life is football',
        url: 'https://img.freepik.com/free-photo/young-hispanic-sport-man-who-feels-confident-crossing-arms-with-determination_1187-24466.jpg?size=626&ext=jpg',
        members: [],
        messages: []
    },
    {
    ...
    },
    {
        id: 5,
        admin: 1,
        nameRoom: 'Maria Montoya',
        state: 'i am so much happy',
